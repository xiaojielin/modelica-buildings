...
block SupplyAirTempSet_MultiZone
  ...
  CDL.Interfaces.RealInput TOut(final unit="K",
    quantity="ThermodynamicTemperature")
    "Outdoor air temperature"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  CDL.Interfaces.RealInput TMax(min=TSupDes, max=TSupMax,
    final unit="K",
    quantity="ThermodynamicTemperature")
    "Maximum cooling supply temperature "
    annotation (Placement(transformation(extent={{-140,20},{-100,60}})));
  CDL.Interfaces.RealInput TSetZones(final unit="K",
    quantity="ThermodynamicTemperature")
  ...
  CDL.Interfaces.RealOutput TSup(final unit="K",
    quantity="ThermodynamicTemperature")
...
protected
  ...
  CDL.Continuous.Constant minOutTem(k=TOutMin)
    "Lower value of the outdoor air temperature reset range"
    annotation (Placement(transformation(extent={{-60,50},{-40,70}})));
  CDL.Continuous.Constant maxOutTem(k=TOutMax)
    "Higher value of the outdoor air temperature reset range"
    annotation (Placement(transformation(extent={{-60,10},{-40,30}})));
  CDL.Continuous.Constant minSupTem(k=TSupMin)
    "Lowest cooling supply air temperature setpoint"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  CDL.Logical.GreaterThreshold greThr(threshold=1)
    "Operation mode rank higher than occupied mode (1)"
    annotation (Placement(transformation(extent={{-20,-80},{0,-60}})));
  CDL.Logical.LessThreshold lesThr(threshold=4)
  ...
  CDL.Logical.LessThreshold lesThr1(threshold=7)
    "Operation mode rank less than freeze-protection mode (6)"
    annotation (Placement(transformation(extent={{20,-100},{40,-80}})));
  CDL.Logical.GreaterThreshold greThr1(threshold=3)
  ...
  CDL.Continuous.Constant TSupWarUpSetBac(k=35 + 273.15)
...
src=\"modelica://Buildings/Resources/Images/Experimental/OpenBuildingControl/ASHRAE/G36/Atomic/SupplyAirTemperatureSet.png\"/>
</p>
